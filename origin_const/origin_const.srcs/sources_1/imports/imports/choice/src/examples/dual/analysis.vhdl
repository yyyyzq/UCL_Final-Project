...
architecture arch of analysis is
  ...
  signal bits_demod : std_logic_vector(2*BITS-1 downto 0);
  signal bits_ref   : std_logic_vector(2*BITS-1 downto 0);

begin

  bits_demod <= bits_y_demod & bits_x_demod;
  bits_ref   <= bits_y_ref & bits_x_ref;
